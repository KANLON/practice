...
public interface LogMapper {
     ...
     * @return 集合
     **/
    @Select("select * from " +TABLE_NAME+" d where d.htmlname=#{htmlname} and  d.logurl=#{logurl} and d.dt in (#{dt},#{dt2},#{dt4})")
     ...
     * @return 集合
     **/
    @Select("select * from " +TABLE_NAME+" d where d.htmlname=#{htmlname} and  d.logurl=#{logurl} and (d.dt=#{dt} or d.dt=#{dt2} or d.dt=#{dt4})")
