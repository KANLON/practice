...
public class QuartzResultService {
     ...
     * @return 结果集
     **/
    public PageDatasModel getQuartzResultByQuartzIdAndResult(long quartzId, String st, String et, Integer execResult,
            PageModel pageModel) {
        PageDatasModel pageDatasModel = new PageDatasModel(pageModel);
        pageDatasModel.setTotalSize(quartzResultMapper.selectResultCntByQuartzIdAndDateAndResult(quartzId, st, et,
                execResult));
        pageDatasModel.setDatas(quartzResultMapper.selectResultByQuartzIdAndDateAndResult(quartzId, st, et,
                execResult, pageModel.getStart(), pageModel.getPageSize()));
    ...
    public PageDatasModel getQuartzResultByQuartzId(long quartzId, String st, String et, PageModel pageModel) {
        ...
        pageDatasModel.setDatas(quartzResultMapper.selectResultByQuartzIdAndDate(quartzId, st, et,
                pageModel.getStart(), pageModel.getPageSize()));
        return pageDatasModel;
    }
