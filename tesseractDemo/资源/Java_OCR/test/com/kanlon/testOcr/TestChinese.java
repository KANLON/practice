...
public class TestChinese {
	...
	public void testDoOCR_File() throws Exception {
		...
		File imageFile = new File(".\\test_example\\测试填写例子.png");
		...
		public List<Word> getWords(File file) {
			...
			try {
				...
				do {
					...
					TessAPI1.TessPageIteratorBoundingBox(pi, TessAPI1.TessPageIteratorLevel.RIL_WORD, leftB, topB,
							rightB, bottomB);
					int left = leftB.get();
					int top = topB.get();
